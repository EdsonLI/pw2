...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.useredepay.com.br';
    ...
    /**
     * User agent of the HTTP request, set to "PHP-RedePay" by default
     *
     * @var string
     */
    protected $userAgent = "RedePay-Codegen/1.0.0/php";
    ...
    {
        $report  = "PHP SDK (RedePay\Client) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
