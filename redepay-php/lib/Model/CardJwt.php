 ...
 */
class CardJwt implements ArrayAccess
{
    /**
    ...
    /**
      * $card_token JWT Token com a listagem dos cartões do comprador
      * @var string
      */
    ...
    /**
     * Sets card_token
     * @param string $card_token JWT Token com a listagem dos cartões do comprador
     * @return $this
     */
