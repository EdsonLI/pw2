...
use \ArrayAccess;
/**
 * GetTransactionItemResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 ...
 */
class GetTransactionItemResponse implements ArrayAccess
{
    /**
    ...
    /**
     * Sets amount
     * @param int $amount Preço do produto
     * @return $this
     */
    ...
    /**
     * Sets id
     * @param string $id Id /SKU do produto
     * @return $this
     */
